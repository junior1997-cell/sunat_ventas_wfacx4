                    ...
                    <div class="card-body">
                        ...
                        <table style="color:black;">
                          <th>
                            <tr>
                              ...
                              <td>TASA %</td>
                              <td>IMPORTE</td>
                              <td>SEGURO: <label style="font-size: 14px;" name="nombreseg" id="nombreseg"></label></td>
                            </tr>
                          </th>
                      ...
                      <div class="row" style="border:2px solid grey; border-radius: 15px;">
                        ...
                        <table style="color:black;">
                          <th>
                            <tr>
                              <td><input class="form-control" type="date" name="fechapagoboleta" id="fechapagoboleta"> </td>
                              <td></td>
                              <td></td>
                              <td></td>
                            </tr>
                            <tr>
                              <td>
                                <h2 id="fechapago" name="fechapago"> </h2>
                              </td>
                            </tr>
                          </th>
                        </table>
