...
?>
    ...
    <div class="content-start transition">
      <div class="container-fluid dashboard">
        <div class="content-header">
          <h1>Clientes <button class="btn btn-primary btn-sm" onclick="mostrarform(true)" data-bs-toggle="modal" data-bs-target="#agregarclientes"> Agregar</button></h1>
        </div>
    ...
    <div class="modal fade text-left" id="agregarclientes" tabindex="-1" role="dialog" aria-labelledby="agregarclientes" aria-hidden="true">
            ...
            <form name="formulario" id="formulario" method="POST">
              <div class="row">
                ...
                <div class="mb-3 col-lg-3">
                  ...
                  <input type="text" class="form-control" name="numero_documento" id="numero_documento" maxlength="11" placeholder="Documento" onkeypress="return NumCheckrz(event, this)">
                ...
                <div class="mb-3 col-lg-3">
                  ...
                  <input type="text" class="form-control" name="nombres" id="nombres" maxlength="100" placeholder="Nombres" required="true" onkeyup="mayus(this);" onkeypress="focusnombre(event)">
                </div>
                <div class="mb-3 col-lg-3">
                  <label for="message-text" class="col-form-label">Apellidos:</label>
                  <input type="text" class="form-control" name="apellidos" id="apellidos" maxlength="100" placeholder="Apellidos " required onkeyup="mayus(this);" onkeypress="focusapellido(event)">
                </div>


                <div class="mb-3 col-lg-3">
                  <label for="message-text" class="col-form-label">Razón social:</label>
                  <input type="text" class="form-control" name="razon_social" id="razon_social" placeholder="Razón social" required onkeyup="mayus(this);" onkeypress="focusrz(event)">
                </div>

                <div class="mb-3 col-lg-3">
                  <label for="message-text" class="col-form-label">Nombre comercial:</label>
                  <input type="text" class="form-control" name="nombre_comercial" id="nombre_comercial" placeholder="Nombre comercial" required onkeyup="mayus(this);" onkeypress="focusnc(event)">
                </div>

                <div class="mb-3 col-lg-3">
                  <label for="message-text" class="col-form-label">Domicilio fiscal:</label>
                  <input type="text" class="form-control" name="domicilio_fiscal" id="domicilio_fiscal" placeholder="Domicilio fiscal" required onkeyup="mayus(this);" onkeypress="focusdf(event)">
                </div>
                ...
                <div class="mb-3 col-lg-3">
                  ...
                  <input type="text" class="form-control" name="telefono1" id="telefono1" maxlength="15" placeholder="Teléfono 1" onkeypress="return NumChecktel1(event, this)">
                </div>

                <div class="mb-3 col-lg-3">
                  <label for="message-text" class="col-form-label">Teléfono 2:</label>
                  <input type="text" class="form-control" name="telefono2" id="telefono2" maxlength="15" placeholder="Teléfono 2" onkeypress="return NumChecktel2(event, this)">
                </div>

                <div class="mb-3 col-lg-3">
                  <label for="message-text" class="col-form-label">Email:</label>
                  <input type="text" class="form-control" name="email" id="email" maxlength="50" placeholder="Email" required="true" onkeypress="focusmail(event)">
                </div>
