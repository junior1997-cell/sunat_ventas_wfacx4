    ...
    <div class="">
      ...
      <section class="">
        <div class="content-header">
          <h1>Factura electrónica<button class="btn btn-info btn-sm" id="btnagregar" onclick="mostrarform(true)">Nuevo</button> <button class="btn btn-success btn-sm" id="refrescartabla" onclick="refrescartabla()">Refrescar</button></h1>
        </div>
        <div class="row"">
                                  <div class=" col-md-12">
          <div class="manej" hidden>
            OFF <input type="checkbox" checked name="chk1" id="chk1" onclick="pause()" data-toggle="tooltip" title="Automatizar envio a SUNAT"> ON
          </div>
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="mb-3 col-lg-6">
                          ...
                          <input type="text" style="font-size: 12pt;" name="numero_factura" id="numero_factura" class="form-control" required="true" readonly>
                        </div>
                        <div class="mb-3 col-lg-6">
                          <label for="recipient-name" class="col-form-label">Tipo de item:</label>
                          <select class="form-control" name="tipofactura" id="tipofactura" onchange="cambiarlistado()">
                            TIPO DE FACTURA
                        ...
                        <div class="mb-3 col-lg-6">
                          ...
                          <select class="form-control" name="tipo_moneda" id="tipo_moneda" onchange="tipodecambiosunat()">
                        ...
                        <div class="mb-3 col-lg-12">
                          ...
                          <input type="text" class="form-control" name="numero_documento2" id="numero_documento2" maxlength="11" placeholder="RUC DE CLIENTE-ENTER" onkeypress="agregarClientexRuc(event)" onblur="quitasuge1()" onfocus="focusTest(this)">
                          <div id="suggestions">
                          </div>
                        </div>
                        <div class="mb-3 col-lg-12">
                        ...
                        <div class="mb-3 col-lg-12">
                          ...
                          <textarea type="text" class="form-control" name="domicilio_fiscal2" id="domicilio_fiscal2" required="true" placeholder="DIRECCIÓN CLIENTE" cols="2" rows="2"></textarea>                          
                        </div>
                        <div hidden class="mb-3 col-lg-6">
                          <label for="recipient-name" class="col-form-label">Correo:</label>
                          <input type="text" class="form-control" name="correocli" id="correocli" placeholder="CORREO CLIENTE" onkeypress="return focusbotonarticulo(event, this)" onfocus="focusTest(this)">
                        </div>
                        <div class="mt-2 mb-3 col-lg-12">
                          <textarea name="descripcion_leyenda_2" id="descripcion_leyenda_2" cols="5" rows="3" class="form-control" placeholder="Observaciones" value="DESCRIPCION DE LEYENDA"></textarea>
                        </div>
                        <div hidden class="mb-3 col-lg-6">
                        ...
                        <div id="tipopagodiv" style="display: none;">
                          <div class="mb-3 col-lg-12">
                            ...
                            <div class="input-group">
                              <span hidden style="cursor:pointer;" class="input-group-text" data-bs-toggle="modal" title="mostrar cuotas" data-bs-target="#modalcuotas" id="basic-addon1">&#9769;</span>
                        ...
                        <div class="mb-3 col-lg-6" hidden>
                          <label for="recipient-name" class="col-form-label">Tipo
                            impuesto:</label>
                          IGV<input type="checkbox" name="vuniigv" id="vuniigv" onclick="modificarSubototales()" data-toggle="tooltip" title="">Valor
                        </div>
                        ...
                        <div class="form-group col-lg-2 col-md-6 col-sm-6 col-xs-12" hidden>
                          ...
                          <img src="../files/articulos/transferencia.png" data-toggle="tooltip" title="Pago por transferencia">
                        ...
                        <div class="modal fade text-left" id="modalcuotas" role="dialog" aria-labelledby="modalcuotas" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-scrollable" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <button hidden id="" type="submit" class="btn btn-primary ml-1" data-bs-dismiss="modal">
                ...
                <div class="col-md-9">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <button style="margin-left:0px;" data-bs-toggle="modal" data-bs-target="#myModalArt" id="btnAgregarArt" type="button" class="btn btn-danger btn-s mb-3" onclick="cambiarlistadoum2()">
                        Agregar Productos o Servicios
                      </button>
                      <div class="mb-3 col-lg-12">
                        <!-- <label for="recipient-name" class="col-form-label">Escanee código de barras:</label> -->
                        <input type="text" name="codigob" id="codigob" class="form-control" onkeypress="agregarArticuloxCodigo(event)" onkeyup="mayus(this);" placeholder="Digite o escanee el código de barras" onblur="quitasuge3()" style="background-color: #F5F589;">
                        <div id="suggestions3">
                        </div>
                      </div>
                              ...
                              <p class="card-text">
                                <th style="font-weight: bold; background-color:#FFB887;">
                                  <div style="display:flex;">
                                    ...
                                    <input hidden placeholder="0.00" readonly style="font-weight: bold; margin: 0 auto; top: 10px; margin-top: 4px; margin-right: 0px; text-align: right; border:none;" name="subtotal_factura" id="subtotal_factura">
                                  </div>
                                  <div style="display:flex;">
                                    <label for="">IGV : </label>
                                    <h6 style="font-weight: bold; margin: 0 auto; top: 10px; margin-top: 4px; margin-right: 0px;" id="igv_"> 0.00</h6>
                                    <input hidden placeholder="0.00" readonly style="font-weight: bold; margin: 0 auto; top: 10px; margin-top: 4px; margin-right: 0px; text-align: right; border:none;" name="total_igv" id="total_igv">
                                  </div>
                                  <div style="display:flex;">
                                ...
                                <input type="hidden" name="total_igv" id="total_igv"> -->
                                  ...
                                  <input type="hidden" name="ipagado_final" id="ipagado_final"><!--Datos de impuestos-->
                                  <!--TOTAL-->
                                  <input type="hidden" name="saldo_final" id="saldo_final">
                                </th>
                                <!--Datos de impuestos--> <!--TOTAL-->
                              <h4 hidden id="icbper">0</h4>
                              <input hidden type="text" id="otroscargos" name="otroscargos" onchange="modificarSubototales();" disabled value="0.00">
                      ...
                      <button style="margin-left:0px;" class="btn btn-primary btn-sm" type="submit" id="btnGuardar" data-toggle="tooltip" title="Guardar Factura"><i class="fa fa-save"></i>
                        Guardar
                      </button>
            ...
            <form name="formularioncliente" id="formularioncliente" method="POST">
              <div class="row">
                ...
                <div class="mb-3 col-lg-12">
                  ...
                  <textarea class="form-control" name="razon_social" id="razon_social" maxlength="100" placeholder="Razón social" required onkeypress="return focusDomi(event, this)" cols="2" rows="2"></textarea>                  
                </div>
                <div class="mb-3 col-lg-12">
                  <label for="message-text" class="col-form-label">Domicilio Fizcal:</label>
                  <textarea  class="form-control" name="domicilio_fiscal" id="domicilio_fiscal" placeholder="Domicilio fiscal" onkeypress="focustel(event, this)" required cols="2" rows="2"></textarea>                  
                </div>
                <div class="mb-3 col-lg-6">
        ...
        <div class="modal-content">
          ...
          <div class="text-center">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              AL CORREO:
              <h3 id="ultimocomprobantecorreo"></h3>
            ...
            <img src="../files/vistaprevia/hoja.jpg">
          </div>
          <div class="modal-footer">
      ...
      <div class="modal-dialog modal-lg" style="max-width: 70% !important;">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <iframe name="modalxml" id="modalxml" border="0" frameborder="0" width="100%" style="height: 800px;" marginwidth="1" src=""></iframe>
          </div>
          <div class="modal-footer">
        ...
        <div class="modal-content">
          ...
          <form name="formularionarticulo" id="formularionarticulo" method="POST">
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
              ...
              <input type="text" class="form-control focus" name="nombrenarticulo" id="nombrenarticulo" placeholder="Nombre" onkeyup="mayus(this);" onkeypress=" return limitestockf(event, this)" autofocus="true" onchange="generarcodigonarti()">
            </div>
            <div class="form-group col-lg-2 col-md-6 col-sm-6 col-xs-12">
              <label>Stock:</label>
              <input type="text" class="" name="stocknarticulo" id="stocknarticulo" maxlength="100" placeholder="Stock" required="true" onkeypress="return NumCheck(event, this)">
            </div>
            <div class="form-group col-lg-2 col-md-6 col-sm-6 col-xs-12">
