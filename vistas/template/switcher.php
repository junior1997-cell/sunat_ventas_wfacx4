  ...
  <div class="offcanvas-body">
    <nav class="border-bottom border-block-end-dashed">
      <div class="nav nav-tabs nav-justified" id="switcher-main-tab" role="tablist">
        <button class="nav-link active" id="switcher-home-tab" data-bs-toggle="tab" data-bs-target="#switcher-home" type="button" role="tab" aria-controls="switcher-home" aria-selected="true">Estilos del sistema</button>
        <button class="nav-link" id="switcher-profile-tab" data-bs-toggle="tab" data-bs-target="#switcher-profile" type="button" role="tab" aria-controls="switcher-profile" aria-selected="false">Colores del istema</button>
      </div>
    </nav>
    <div class="tab-content" id="nav-tabContent">
      <div class="tab-pane fade show active border-0" id="switcher-home" role="tabpanel" aria-labelledby="switcher-home-tab" tabindex="0">
        <div class="">
          <p class="switcher-style-head">Modo de apariencia:</p>
        ...
        <div class="">
          <p class="switcher-style-head">Direccional:</p>
          <div class="row switcher-style gx-0">
            <div class="col-4">
              <div class="form-check switch-select">
        ...
        <div class="">
          <p class="switcher-style-head">Activar Pleload de página:</p>
          <div class="row switcher-style gx-0">
            <div class="col-4">
              <div class="form-check switch-select">
      ...
      <div class="tab-pane fade border-0" id="switcher-profile" role="tabpanel" aria-labelledby="switcher-profile-tab" tabindex="0">
        <div>
          <div class="theme-colors">
            ...
            <div class="px-4 pb-3 text-muted fs-11">Nota: Si desea cambiar el color del Menú dinámicamente
              cambiar desde abajo Tema Selector de color primario</div>
          </div>
          <div class="theme-colors">
            ...
            <div class="px-4 pb-3 text-muted fs-11">Nota: Si desea cambiar el color del encabezado
              dinámicamente
              cambiar desde abajo Tema Selector de color primario</div>
          </div>
          <div class="theme-colors">
      ...
      <div class="d-grid canvas-footer">
        <a href="javascript:void(0);" id="reset-all" class="btn btn-danger m-1">Resetar Valores</a>
      </div>
    </div>
  </div>
</div>
