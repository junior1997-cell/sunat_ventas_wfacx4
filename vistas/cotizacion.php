...
?>
                        ...
                        <div class="card-body">
                          <div class="row">
                            ...
                            <div class="mb-3 col-lg-2">
                              ...
                              <input class="form-control" name="numero_cotizacion" id="numero_cotizacion" required="true" readonly>
                            </div>
                            ...
                            <div class="mb-3 col-lg-2">
                              ...
                              <input type="date" class="form-control" name="fechavalidez" id="fechavalidez" required="true" min="<?php echo date('Y-m-d'); ?>">
                            </div>
                            <div class="mb-3 col-lg-2">
                            ...
                            <div class="mb-3 col-lg-2">
                              ...
                              <input type="text" name="tcambio" id="tcambio" class="form-control" readonly="true" onkeypress="focotcaruc(event, this)">
                            </div>
                            <div class="mb-3 col-lg-2">
                            ...
                            <div class="mb-3 col-lg-12">
                              ...
                              <textarea class="form-control" name="observacion" id="observacion" placeholder="OBSERVACIÓN" rows="5" cols="70"></textarea>
                            </div>
                            <div class="mb-3 col-lg-2">
                              <label for="recipient-name" class="col-form-label">Tipo precio:</label>
                              <select class="form-control" name="tipocotizacion" id="tipocotizacion" onchange="seleccionTipoCot()">
                            ...
                            <div class="col-lg-2" style="margin-top: 41px;">
                              <a data-bs-toggle="modal" data-bs-target="#myModalArt" class="btn btn-primary btn-sm" id="btnAgregarArt">Agregar Productos</a>
                            </div>
                            <div class="mb-3 col-lg-2" style="display: none;">
                              <button ata-toggle="modal" href="#myModalServ" id="btnAgregarArt" type="button" class="btn btn-primary"> Servicios</button>
                            </div>
                            <div class="table-responsive">
                              <div class="table-responsive" id="detallesproductoDIV" style="display: none;">
                                <table id="detallesproducto" class="table table-striped" style="font-size: 14px; max-width: 100% !important;">
                                  <thead style="text-align:center;">
                                    <th>Sup.</th>
                                    <th>Item</th>
                                    <th>Artículo</th>
                                  ...
                                  <tfoot style="vertical-align: center;">
                                    ...
                                    <!--Datos de
                                       Impuestos--> <!--IGV-->
                                    <th style="font-weight: bold;">
                                      <h4 id="total" style="font-weight: bold; vertical-align: center; font-size: 14px">
                                        0.00</h4>
                                    </th>
                            ...
                            <div class="table-responsive" id="detallesservicioDIV" style="display: none;">
                              <table id="detallesservicio" class="table table-striped" style="font-size: 14px; max-width: 100% !important;">
                                <thead style="text-align:center;">
                                  <th>Opciones</th>
                                  <th>Item</th>
                                  <th>Servicio</th>
                                ...
                                <tfoot style="vertical-align: center;">
                                  ...
                                  <!--Datos de
                                    impuestos--> <!--IGV-->
                                  <th style="font-weight: bold;">
                                    <h4 id="total_servicio" style="font-weight: bold; vertical-align: center;">0.00</h4>
                                    <input type="hidden" name="total_final_servicio" id="total_final_servicio">
                                    <input type="hidden" name="subtotal_cotizacion_servicio" id="subtotal_cotizacion_servicio">
                            ...
                            <div class="btn-list">
                              <button type="submit" id="btnGuardar" class="btn btn-primary btn-sm btn-wave waves-effect waves-light">Guardar</button>
                              <button id="btnCancelar" onclick="cancelarform()" type="button" class="btn btn-danger btn-sm btn-wave waves-effect waves-light">Cancelar</button>
                            </div>
    ...
    <div class="modal fade text-left" id="myModalnfac" tabindex="-1" role="dialog" aria-labelledby="myModalnfac" aria-hidden="true">
          ...
          <div class="modal-body" id="formularioregistros">
            <form name="formularionfactura" id="formularionfactura" method="POST" autocomplete="off">
              ...
              <div class="row">
                <div class="mb-3 col-lg-2">
                  <label>Serie</label>
                  <select class="form-control" name="seriefactura" id="seriefactura" onchange="incrementarNumfactura();"></select>
                ...
                <div class="mb-3 col-lg-2">
                  ...
                  <input type="date" style="font-size: 12pt;" class="form-control" name="fecemifa" id="fecemifa" required="true">
                </div>
                <div class="mb-3 col-lg-2">
                  <label>Moneda:</label>
                ...
                <div class="mb-3 col-lg-2">
                  ...
                  <input type="text" class="form-control" name="numero_documento_factura" id="numero_documento_factura" readonly>
                </div>
                ...
                <div class="mb-3 col-lg-4">
                  ...
                  <textarea id="observaciocoti" name="observaciocoti" class="form-control" style="color: red;" readonly=""> </textarea>
                </div>
                <div class="mb-3 col-lg-2">
                  <label style="top: 25px; position: relative;">Pago con tarjeta</label>
                  <input class="form-control" type="checkbox" name="tarjetadc" id="tarjetadc" onclick="activartarjetadc();" style="top: 30px;">
                  <input class="form-control" type="hidden" name="tadc" id="tadc">
                </div>
                <div class="mb-3 col-lg-2">
                  <label style="top: 25px; position: relative;">Pago Transferencia</label>
                  <input type="checkbox" name="transferencia" id="transferencia" onclick="activartransferencia();" style="top: 30px;">
                  <input class="form-control" type="hidden" name="trans" id="trans">
                </div>
                <div class="mb-3 col-lg-2">
                  <label>Nro de operación:</label>
                  <input type="text" name="nroreferenciaf" id="nroreferenciaf" class="form-control" style="color: blue;" placeholder="N° operación del comprobante">
                </div>
                ...
                <div class="form-group col-lg-4 col-md-6 col-sm-6 col-xs-6">
                  ...
                  <button id="btnCancelar" class="btn btn-danger" data-toggle="tooltip" title="Cancelar" data-dismiss="modal" type="button"><i class="fa fa-arrow-circle-left"> Cancelar</i></button>
                </div>
      ...
      <div class="modal fade" id="modalTcambio">
        <div class="modal-dialog" style="width: 100% !important;">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-danger btn-ver" data-dismiss="modal" onclick="focotcambio()">Cerrar</button>
            </div>
          </div>
        </div>
      </div>
            ...
            <form name="formularioncliente" id="formularioncliente" method="POST">
              <div class="row">
                ...
                <div class="mb-3 col-lg-6">
                  ...
                  <input type="text" class="form-control" name="domicilio_fiscal" id="domicilio_fiscal" placeholder="Domicilio fiscal" required onkeypress="focustel(event, this)">
                </div>
                <div class="mb-3 col-lg-6">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="mb-3 col-lg-3">
                <label for=""></label><br>
                <button class="btn btn-success" id="refrescartabla" style="top: 3px;" onclick="refrescartabla()"><i class="fa fa-refresh fa-spin fa-1x fa-fw"></i>
