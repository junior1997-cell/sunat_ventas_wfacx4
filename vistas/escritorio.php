...
if (!isset($_SESSION["nombre"])) {
  ...
  if ($_SESSION['Dashboard'] == 1) {
    ...
    $productosmasvendidos = empty($regv->total)? 0 : $regv->total;

    // echo json_encode($productosmasvendidos, true);die();
        ...
        <div class="modal-content">
          ...
          <form name="formulariois" id="formulariois" action="../reportes/.php" method="POST" target="_blank">
            ...
            <!-- <div class="form-group col-lg-2 col-md-4 col-sm-6 col-xs-12">
              ...
              <button class="btn btn-primary" type="submit" id="btnconsulta"  data-toggle="tooltip" title="Consultar" onclick="return enviar();" ><i class="fa fa-print" ></i> Reporte </button>
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                      <div>
                        ...
                        <span class="d-block fw-semibold mt-1"><a class="text-fixed-white" href="https://wa.link/oetgkf" target="_blank"><u>SOPORTE</u></a></span>
                      </div>
                      <div>
                        <div id="crm-main"></div>
                      </div>
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-top justify-content-between">
                      ...
                      <div class="flex-fill ms-3">
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-1">
                          <div>
                            <a class="text-primary" id="guardarTotal" type="button">Guardado automatico<i class="ti ti-arrow-narrow-right ms-2 fw-semibold d-inline-block"></i></a>
                          </div>
                          <div class="text-end">
                            <p class="mb-0 text-success fw-semibold">+</p>
                            <span class="text-muted op-7 fs-11">monto diario</span>
