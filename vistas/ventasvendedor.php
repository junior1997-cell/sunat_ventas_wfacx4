          ...
          <div class="col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <canvas id="ventas" style="display: block; width: 735px; height: 367px;" class="chartjs-render-monitor" width="735" height="367"></canvas>
              </div>
            </div>
          </div>
          <div class="col-md-6">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="mb-3 col-lg-4">
                    ...
                    <select class="form-control" name="vendedorsitio" id="vendedorsitio" onchange="listarVentasVendedor()"></select>
                  </div>
