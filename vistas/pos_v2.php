                ...
                <div class="col-lg-8 position-relative">
                  ...
                  <div class="cards-products contenedor">
                    ...
                    <div class="row pe-1" id="product-containe">
                      <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12"> <div class="card custom-card product-card"> <div class="card-body text-center"> <a href="product-details.html" class="product-image text-center"> <img src="../assets/images/ecommerce/png/1.png" class="card-img mb-3" alt="..." width="10px" height="auto" style="width: 100px !important;"> </a> <div class="product-icons"> <a href="wishlist.html" class="wishlist"><i class="ri-heart-line"></i></a> <a href="cart.html" class="cart"><i class="ri-shopping-cart-line"></i></a> <a href="product-details.html" class="view"><i class="ri-eye-line"></i></a> </div> <p class="product-name fw-semibold mb-0 d-flex align-items-center justify-content-between">BMW<span class="float-end text-warning fs-12">4.1<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p><p class="product-description fs-11 text-muted mb-2">Ethnic wear jackets form BMW</p><p class="mb-1 fw-semibold fs-16 d-flex align-items-center justify-content-between"><span>$1,499<span class="text-muted text-decoration-line-through ms-1 d-inline-block op-6">$2,499</span></span><span class="badge bg-secondary-transparent float-end fs-10">38% off</span></p><p class="fs-11 text-success fw-semibold mb-0 d-flex align-items-center"> <i class="ti ti-discount-2 fs-16 me-1"></i>Offer Price $1,499</p></div> </div> </div>
