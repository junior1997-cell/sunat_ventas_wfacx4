  ...
  if (!isset($_SESSION["nombre"])) {
    ...
    <html lang="es" dir="ltr" data-nav-layout="vertical" data-theme-mode="light" data-header-styles="light" data-menu-styles="dark" data-toggled="close">
      ...
      <head>
        ...
        <link rel="stylesheet" href="https://spruko.com/demo/ynex/dist/assets/libs/choices.js/public/assets/scripts/choices.min.js">
        <link rel="stylesheet" href="https://spruko.com/demo/ynex/dist/assets/libs/bootstrap/css/bootstrap.min.css">
        <link rel="stylesheet" href="https://spruko.com/demo/ynex/dist/assets/js/main.js">
        <link rel="stylesheet" href="https://spruko.com/demo/ynex/dist/assets/libs/choices.js/public/assets/scripts/choices.min.js">
        <link rel="stylesheet" href="https://spruko.com/demo/ynex/dist/assets/css/styles.min.css">
        <link rel="stylesheet" href="https://spruko.com/demo/ynex/dist/assets/css/icons.css">
        <link rel="stylesheet" href="https://spruko.com/demo/ynex/dist/assets/libs/node-waves/waves.min.css">
        <link rel="stylesheet" href="https://spruko.com/demo/ynex/dist/assets/libs/choices.js/public/assets/styles/choices.min.css">
        <link rel="stylesheet" href="https://spruko.com/demo/ynex/dist/assets/libs/nouislider/nouislider.min.css">
      </head>
      ...
      <body>
        ...
        if ($_SESSION['Ventas'] == 1) { ?>
              ...
              <div class="row">
                <div class="col-lg-8 position-relative">
                        ...
                        <div class="col-12 col-md-9 row pe-0">
                          <div class="col-12 col-md-6 pe-0 d-flex align-items-center">
                            ...
                            <div class="input-group" style="border: 1px solid #ccc; border-radius: 0.25rem;">
                              <input class="form-control border-0" type="text" id="search_product" placeholder="Filtro por código o nombre">
                              <button class="btn btn-outline-secondary border-0 color-gray-500 pe-1 ps-0" type="button" disabled>
                                <i class="fas fa-search"></i>
                              </button>
                              <button class="btn btn-outline-secondary delete border-0 color-gray-500" type="button" id="btn_deletefilter">
                  ...
                  <div class="cards-products contenedor">
                    ...
                    <div class="row pe-1" id="product-containe">
                      <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12"> <div class="card custom-card product-card"> <div class="card-body text-center"> <a href="product-details.html" class="product-image text-center"> <img src="../assets/images/ecommerce/png/1.png" class="card-img mb-3" alt="..." width="10px" height="auto" style="width: 100px !important;"> </a> <div class="product-icons"> <a href="wishlist.html" class="wishlist"><i class="ri-heart-line"></i></a> <a href="cart.html" class="cart"><i class="ri-shopping-cart-line"></i></a> <a href="product-details.html" class="view"><i class="ri-eye-line"></i></a> </div> <p class="product-name fw-semibold mb-0 d-flex align-items-center justify-content-between">Lacoste<span class="float-end text-warning fs-12">4.1<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p><p class="product-description fs-11 text-muted mb-2">Ethnic wear jackets form BMW</p><p class="mb-1 fw-semibold fs-14 d-flex align-items-center justify-content-between"><span>$1,499<span class="fs-10 text-muted text-decoration-line-through ms-1 d-inline-block op-6">$2,499</span></span><span class="badge bg-secondary-transparent float-end font-size-7px">38% off</span></p><p class="fs-11 text-success fw-semibold mb-0 d-flex align-items-center"> <i class="ti ti-discount-2 fs-16 me-1"></i>Offer Price $1,499</p></div> </div> </div>
                      <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12"> <div class="card custom-card product-card"> <div class="card-body text-center"> <a href="product-details.html" class="product-image text-center"> <img src="../assets/images/ecommerce/png/2.png" class="card-img mb-3" alt="..." width="10px" height="auto" style="width: 100px !important;"> </a> <div class="product-icons"> <a href="wishlist.html" class="wishlist"><i class="ri-heart-line"></i></a> <a href="cart.html" class="cart"><i class="ri-shopping-cart-line"></i></a> <a href="product-details.html" class="view"><i class="ri-eye-line"></i></a> </div> <p class="product-name fw-semibold mb-0 d-flex align-items-center justify-content-between">Tommy Hilfiger<span class="float-end text-warning fs-12">4.1<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p><p class="product-description fs-11 text-muted mb-2">Ethnic wear jackets form BMW</p><p class="mb-1 fw-semibold fs-14 d-flex align-items-center justify-content-between"><span>$1,499<span class="fs-10 text-muted text-decoration-line-through ms-1 d-inline-block op-6">$2,499</span></span><span class="badge bg-secondary-transparent float-end font-size-7px">38% off</span></p><p class="fs-11 text-success fw-semibold mb-0 d-flex align-items-center"> <i class="ti ti-discount-2 fs-16 me-1"></i>Offer Price $1,499</p></div> </div> </div>
                      <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12"> <div class="card custom-card product-card"> <div class="card-body text-center"> <a href="product-details.html" class="product-image text-center"> <img src="../assets/images/ecommerce/png/3.png" class="card-img mb-3" alt="..." width="10px" height="auto" style="width: 100px !important;"> </a> <div class="product-icons"> <a href="wishlist.html" class="wishlist"><i class="ri-heart-line"></i></a> <a href="cart.html" class="cart"><i class="ri-shopping-cart-line"></i></a> <a href="product-details.html" class="view"><i class="ri-eye-line"></i></a> </div> <p class="product-name fw-semibold mb-0 d-flex align-items-center justify-content-between">Ted Baker<span class="float-end text-warning fs-12">4.1<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p><p class="product-description fs-11 text-muted mb-2">Ethnic wear jackets form BMW</p><p class="mb-1 fw-semibold fs-14 d-flex align-items-center justify-content-between"><span>$1,499<span class="fs-10 text-muted text-decoration-line-through ms-1 d-inline-block op-6">$2,499</span></span><span class="badge bg-secondary-transparent float-end font-size-7px">38% off</span></p><p class="fs-11 text-success fw-semibold mb-0 d-flex align-items-center"> <i class="ti ti-discount-2 fs-16 me-1"></i>Offer Price $1,499</p></div> </div> </div>
                      <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12"> <div class="card custom-card product-card"> <div class="card-body text-center"> <a href="product-details.html" class="product-image text-center"> <img src="../assets/images/ecommerce/png/4.png" class="card-img mb-3" alt="..." width="10px" height="auto" style="width: 100px !important;"> </a> <div class="product-icons"> <a href="wishlist.html" class="wishlist"><i class="ri-heart-line"></i></a> <a href="cart.html" class="cart"><i class="ri-shopping-cart-line"></i></a> <a href="product-details.html" class="view"><i class="ri-eye-line"></i></a> </div> <p class="product-name fw-semibold mb-0 d-flex align-items-center justify-content-between">John Smedley<span class="float-end text-warning fs-12">4.1<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p><p class="product-description fs-11 text-muted mb-2">Ethnic wear jackets form BMW</p><p class="mb-1 fw-semibold fs-14 d-flex align-items-center justify-content-between"><span>$1,499<span class="fs-10 text-muted text-decoration-line-through ms-1 d-inline-block op-6">$2,499</span></span><span class="badge bg-secondary-transparent float-end font-size-7px">38% off</span></p><p class="fs-11 text-success fw-semibold mb-0 d-flex align-items-center"> <i class="ti ti-discount-2 fs-16 me-1"></i>Offer Price $1,499</p></div> </div> </div>
                      <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12"> <div class="card custom-card product-card"> <div class="card-body text-center"> <a href="product-details.html" class="product-image text-center"> <img src="../assets/images/ecommerce/png/5.png" class="card-img mb-3" alt="..." width="10px" height="auto" style="width: 100px !important;"> </a> <div class="product-icons"> <a href="wishlist.html" class="wishlist"><i class="ri-heart-line"></i></a> <a href="cart.html" class="cart"><i class="ri-shopping-cart-line"></i></a> <a href="product-details.html" class="view"><i class="ri-eye-line"></i></a> </div> <p class="product-name fw-semibold mb-0 d-flex align-items-center justify-content-between">BMW<span class="float-end text-warning fs-12">4.1<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p><p class="product-description fs-11 text-muted mb-2">Ethnic wear jackets form BMW</p><p class="mb-1 fw-semibold fs-14 d-flex align-items-center justify-content-between"><span>$1,499<span class="fs-10 text-muted text-decoration-line-through ms-1 d-inline-block op-6">$2,499</span></span><span class="badge bg-secondary-transparent float-end font-size-7px">38% off</span></p><p class="fs-11 text-success fw-semibold mb-0 d-flex align-items-center"> <i class="ti ti-discount-2 fs-16 me-1"></i>Offer Price $1,499</p></div> </div> </div>
                      <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12"> <div class="card custom-card product-card"> <div class="card-body text-center"> <a href="product-details.html" class="product-image text-center"> <img src="../assets/images/ecommerce/png/6.png" class="card-img mb-3" alt="..." width="10px" height="auto" style="width: 100px !important;"> </a> <div class="product-icons"> <a href="wishlist.html" class="wishlist"><i class="ri-heart-line"></i></a> <a href="cart.html" class="cart"><i class="ri-shopping-cart-line"></i></a> <a href="product-details.html" class="view"><i class="ri-eye-line"></i></a> </div> <p class="product-name fw-semibold mb-0 d-flex align-items-center justify-content-between">COS<span class="float-end text-warning fs-12">4.1<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p><p class="product-description fs-11 text-muted mb-2">Ethnic wear jackets form BMW</p><p class="mb-1 fw-semibold fs-14 d-flex align-items-center justify-content-between"><span>$1,499<span class="fs-10 text-muted text-decoration-line-through ms-1 d-inline-block op-6">$2,499</span></span><span class="badge bg-secondary-transparent float-end font-size-7px">38% off</span></p><p class="fs-11 text-success fw-semibold mb-0 d-flex align-items-center"> <i class="ti ti-discount-2 fs-16 me-1"></i>Offer Price $1,499</p></div> </div> </div>
                      <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12"> <div class="card custom-card product-card"> <div class="card-body text-center"> <a href="product-details.html" class="product-image text-center"> <img src="../assets/images/ecommerce/png/7.png" class="card-img mb-3" alt="..." width="10px" height="auto" style="width: 100px !important;"> </a> <div class="product-icons"> <a href="wishlist.html" class="wishlist"><i class="ri-heart-line"></i></a> <a href="cart.html" class="cart"><i class="ri-shopping-cart-line"></i></a> <a href="product-details.html" class="view"><i class="ri-eye-line"></i></a> </div> <p class="product-name fw-semibold mb-0 d-flex align-items-center justify-content-between">Sunspel<span class="float-end text-warning fs-12">4.1<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p><p class="product-description fs-11 text-muted mb-2">Ethnic wear jackets form BMW</p><p class="mb-1 fw-semibold fs-14 d-flex align-items-center justify-content-between"><span>$1,499<span class="fs-10 text-muted text-decoration-line-through ms-1 d-inline-block op-6">$2,499</span></span><span class="badge bg-secondary-transparent float-end font-size-7px">38% off</span></p><p class="fs-11 text-success fw-semibold mb-0 d-flex align-items-center"> <i class="ti ti-discount-2 fs-16 me-1"></i>Offer Price $1,499</p></div> </div> </div>
                      <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12"> <div class="card custom-card product-card"> <div class="card-body text-center"> <a href="product-details.html" class="product-image text-center"> <img src="../assets/images/ecommerce/png/8.png" class="card-img mb-3" alt="..." width="10px" height="auto" style="width: 100px !important;"> </a> <div class="product-icons"> <a href="wishlist.html" class="wishlist"><i class="ri-heart-line"></i></a> <a href="cart.html" class="cart"><i class="ri-shopping-cart-line"></i></a> <a href="product-details.html" class="view"><i class="ri-eye-line"></i></a> </div> <p class="product-name fw-semibold mb-0 d-flex align-items-center justify-content-between">Ralph Lauren<span class="float-end text-warning fs-12">4.1<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p><p class="product-description fs-11 text-muted mb-2">Ethnic wear jackets form BMW</p><p class="mb-1 fw-semibold fs-14 d-flex align-items-center justify-content-between"><span>$1,499<span class="fs-10 text-muted text-decoration-line-through ms-1 d-inline-block op-6">$2,499</span></span><span class="badge bg-secondary-transparent float-end font-size-7px">38% off</span></p><p class="fs-11 text-success fw-semibold mb-0 d-flex align-items-center"> <i class="ti ti-discount-2 fs-16 me-1"></i>Offer Price $1,499</p></div> </div> </div>
                      <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12"> <div class="card custom-card product-card"> <div class="card-body text-center"> <a href="product-details.html" class="product-image text-center"> <img src="../assets/images/ecommerce/png/6.png" class="card-img mb-3" alt="..." width="10px" height="auto" style="width: 100px !important;"> </a> <div class="product-icons"> <a href="wishlist.html" class="wishlist"><i class="ri-heart-line"></i></a> <a href="cart.html" class="cart"><i class="ri-shopping-cart-line"></i></a> <a href="product-details.html" class="view"><i class="ri-eye-line"></i></a> </div> <p class="product-name fw-semibold mb-0 d-flex align-items-center justify-content-between">BMW<span class="float-end text-warning fs-12">4.1<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p><p class="product-description fs-11 text-muted mb-2">Ethnic wear jackets form BMW</p><p class="mb-1 fw-semibold fs-14 d-flex align-items-center justify-content-between"><span>$1,499<span class="fs-10 text-muted text-decoration-line-through ms-1 d-inline-block op-6">$2,499</span></span><span class="badge bg-secondary-transparent float-end font-size-7px">38% off</span></p><p class="fs-11 text-success fw-semibold mb-0 d-flex align-items-center"> <i class="ti ti-discount-2 fs-16 me-1"></i>Offer Price $1,499</p></div> </div> </div>
                      <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12"> <div class="card custom-card product-card"> <div class="card-body text-center"> <a href="product-details.html" class="product-image text-center"> <img src="../assets/images/ecommerce/png/6.png" class="card-img mb-3" alt="..." width="10px" height="auto" style="width: 100px !important;"> </a> <div class="product-icons"> <a href="wishlist.html" class="wishlist"><i class="ri-heart-line"></i></a> <a href="cart.html" class="cart"><i class="ri-shopping-cart-line"></i></a> <a href="product-details.html" class="view"><i class="ri-eye-line"></i></a> </div> <p class="product-name fw-semibold mb-0 d-flex align-items-center justify-content-between">BMW<span class="float-end text-warning fs-12">4.1<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p><p class="product-description fs-11 text-muted mb-2">Ethnic wear jackets form BMW</p><p class="mb-1 fw-semibold fs-14 d-flex align-items-center justify-content-between"><span>$1,499<span class="fs-10 text-muted text-decoration-line-through ms-1 d-inline-block op-6">$2,499</span></span><span class="badge bg-secondary-transparent float-end font-size-7px">38% off</span></p><p class="fs-11 text-success fw-semibold mb-0 d-flex align-items-center"> <i class="ti ti-discount-2 fs-16 me-1"></i>Offer Price $1,499</p></div> </div> </div>
                      <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12"> <div class="card custom-card product-card"> <div class="card-body text-center"> <a href="product-details.html" class="product-image text-center"> <img src="../assets/images/ecommerce/png/6.png" class="card-img mb-3" alt="..." width="10px" height="auto" style="width: 100px !important;"> </a> <div class="product-icons"> <a href="wishlist.html" class="wishlist"><i class="ri-heart-line"></i></a> <a href="cart.html" class="cart"><i class="ri-shopping-cart-line"></i></a> <a href="product-details.html" class="view"><i class="ri-eye-line"></i></a> </div> <p class="product-name fw-semibold mb-0 d-flex align-items-center justify-content-between">BMW<span class="float-end text-warning fs-12">4.1<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p><p class="product-description fs-11 text-muted mb-2">Ethnic wear jackets form BMW</p><p class="mb-1 fw-semibold fs-14 d-flex align-items-center justify-content-between"><span>$1,499<span class="fs-10 text-muted text-decoration-line-through ms-1 d-inline-block op-6">$2,499</span></span><span class="badge bg-secondary-transparent float-end font-size-7px">38% off</span></p><p class="fs-11 text-success fw-semibold mb-0 d-flex align-items-center"> <i class="ti ti-discount-2 fs-16 me-1"></i>Offer Price $1,499</p></div> </div> </div>
                      <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12"> <div class="card custom-card product-card"> <div class="card-body text-center"> <a href="product-details.html" class="product-image text-center"> <img src="../assets/images/ecommerce/png/6.png" class="card-img mb-3" alt="..." width="10px" height="auto" style="width: 100px !important;"> </a> <div class="product-icons"> <a href="wishlist.html" class="wishlist"><i class="ri-heart-line"></i></a> <a href="cart.html" class="cart"><i class="ri-shopping-cart-line"></i></a> <a href="product-details.html" class="view"><i class="ri-eye-line"></i></a> </div> <p class="product-name fw-semibold mb-0 d-flex align-items-center justify-content-between">BMW<span class="float-end text-warning fs-12">4.1<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p><p class="product-description fs-11 text-muted mb-2">Ethnic wear jackets form BMW</p><p class="mb-1 fw-semibold fs-14 d-flex align-items-center justify-content-between"><span>$1,499<span class="fs-10 text-muted text-decoration-line-through ms-1 d-inline-block op-6">$2,499</span></span><span class="badge bg-secondary-transparent float-end font-size-7px">38% off</span></p><p class="fs-11 text-success fw-semibold mb-0 d-flex align-items-center"> <i class="ti ti-discount-2 fs-16 me-1"></i>Offer Price $1,499</p></div> </div> </div>
                ...
                <div class="col-lg-4 pedido-container" style="position: sticky;">
                  <div class="card pedido-card contenedor" style="overflow: scroll; overflow-y: visible; overflow-x: hidden;">
                    ...
                    <div class="p-3 pb-0">
                      ...
                      <fieldset>
                        <legend>
                          <button class="btn btn-blue btn-sm w-100 fw-500" id="btn_datos" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Completa los datos de tu pedido">Datos</button>
                        </legend>
                      </fieldset>
                      ...
                      <option selected value="" disabled>Seleccionar Serie</option>
                        ...
                        <div hidden class="col-sm-6 mb-2">
                          ...
                          <input type="date" disabled="true" style="font-size: 12pt;" class="form-control" name="fecha_emision_01" id="fecha_emision_01" required="true" onchange="focusTdoc()">
                        ...
                        <div class="col-sm-6 mb-2 doc_ruc">
                          ...
                          <input type="text" class="form-control" name="numero_documento2" id="numero_documento2" maxlength="11" placeholder="RUC DE CLIENTE-ENTER" onkeypress="agregarClientexRuc(event)" onblur="quitasuge1()">
                        ...
                        <div class="col-sm-6 mb-2 doc_ruc">
                          ...
                          <input type="text" class="form-control" name="razon_social2" id="razon_social2" required="true" placeholder="NOMBRE COMERCIAL" onblur="quitasuge2()" onfocus="focusTest(this)">
                          <div id="suggestions2"></div>
                        </div>
                    ...
                    <div class="col-12 pe-2 ps-3 contenedor" style="height: calc(100vh - 375px); overflow: scroll; overflow-x: hidden; overflow-y: visible; min-height: 147px;">
                      ...
                      <div class="row">
                        ...
                        <div class="col-12">
                          ...
                          <div class="row mb-2">
                            ...
                            <input type="text" class="col fw-bold fs-6 form-control-plaintext text-end p-0 pe-2" readonly name="total_igv" id="total_igv" value="0.00">
                          </div>
                          ...
                          <div class="row mb-3">
                            ...
                            <input type="text" class="col fw-bold text-success fs-6 form-control-plaintext text-end p-0 pe-2" readonly name="totalpagar" id="totalpagar" value="0.00">
          ...
          <div class="modal fade" id="modal_agregarproducto" tabindex="-1" aria-labelledby="modal_agregarproducto" aria-hidden="true">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 mb-2">
                        ...
                        <input type="text" class="form-control" name="nombrenarticulo" id="nombrenarticulo" placeholder="Nombre Producto" autofocus="true" onkeyup="mayus(this);" onchange="generarcodigonarti()">
                      </div>

                      <div class="col-sm-6 mb-2">
                        <label for="stocknarticulo" class="form-label">Cantidad del Stock:</label>
                        <input type="number" class="form-control" name="stocknarticulo" id="stocknarticulo" placeholder="Stock Producto" maxlength="100" required="true" onkeypress="return NumCheck(event, this)">
                      </div>
                      ...
                      <div class="col-sm-6 mb-2">
                        ...
                        <input type="text" class="form-control" name="codigonarticulonarticulo" id="codigonarticulonarticulo" placeholder="Código Producto">
                      </div>
                      ...
                      <div hidden class="col-sm-6 mb-2">
                        <textarea class="form-control" id="descripcionnarticulo" name="descripcionnarticulo" rows="3" cols="70" onkeyup="mayus(this)"> </textarea>
                      </div>
          ...
          <!-- MODAL CLIENTES -->
          <div class="modal fade text-left" id="ModalNcliente" tabindex="-1" role="dialog" aria-labelledby="ModalNcliente" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable" role="document">
              <div class="modal-content">
                    ...
                    <div class="row">
                      ...
                      <div class="mb-3 col-lg-12">
                        <div class="input-group">
                          <span type="submit" style="cursor:pointer;" value="burcarclientesunat" name="btn-submit" id="btn-submit" class="input-group-text">&#9769;</span>
                  ...
                  <form name="formularioncliente" id="formularioncliente" method="POST">
                    <div class="row">
                      ...
                      <div class="mb-3 col-lg-6">
                        ...
                        <input type="text" class="form-control" name="iddepartamento" id="iddepartamento" onchange="llenarCiudad()">
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" id="btnguardarncliente" name="btnguardarncliente" class="btn btn-primary ml-1" data-bs-dismiss="modal">
