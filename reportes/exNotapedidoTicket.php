    ...
    <body onload="window.print();">
      ...
      <table border="0" align="center" width="230px">
        <tbody>
          ...
          <tr><td align="center"><strong> NOTA DE PEDIDO </strong></br> <b style="font-size: 14px"><?php echo $reg->numeracion_07; ?></b> </td></tr>
          <tr align="center"><td>=================================</td></tr>
        </tbody>
      </table>
      ...
      <table border="0" align="center" width="230px">
        <tbody>
          <tr align="left"><td><strong>Cliente:</strong></td><td><?php echo $reg->cliente; ?></td></tr>
          <tr align="left"><td><strong>RUC/DNI:</strong></td><td><?php echo $reg->numero_documento; ?></td></tr>
          <tr align="left"><td><strong>Dirección:</strong></td><td><?php echo $reg->direccion; ?></td></tr>
          <tr align="left"><td><strong>F. de emisión:</strong></td><td><?php echo $reg->fecha . " / " . $reg->hora; ?></td></tr>
          <!--  <tr>  <td ><strong>Fecha de Vcto:</strong> <?php echo "."; ?></td> </tr> -->
          <tr align="left"><td><strong>Moneda:</strong></td><td>SOLES</td></tr>
          <tr align="left"><td><strong>Atención:</strong></td><td><?php echo $reg->vendedorsitio; ?></td></tr>
        </tbody>
      </table>
      ...
      <?php
      function shouldDisplayPaymentMethods($record){ return $record->yape > 0 || $record->visa > 0 || $record->efectivo > 0 || $record->plin > 0 || $record->masterC > 0 || $record->dep > 0; }
      ?>
      ...
      <table border="0" align="center" width="230px" style="font-size: 4px">
        ...
        if (shouldDisplayPaymentMethods($reg)) {
          ...
          if ($reg->dep > 0) { echo "<td><strong>Dep.</strong></td>"; }
          ...
          if ($reg->dep > 0) { echo "<td> $reg->dep </td>"; }
      ...
      <br>
      <!-- <div style="text-align: center;" ><img src=<?php echo $logoQr; ?> width="50" height="50"><br><label>Código HASH: <?php echo $reg->hashc;; ?> </label></div> -->
    </body>    </html>
  <?php
  } else {
