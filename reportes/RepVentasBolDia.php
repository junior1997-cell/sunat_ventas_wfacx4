...
$venta = new Venta();
$rspta = $venta->regventareporteBoletaDia($_SESSION['idempresa']);
$rspta2 = $venta->regventareportetotalesBoletaDia( $_SESSION['idempresa']);
...
$pdf->Row(array('',utf8_decode('TOTAL BOLETAS (S/): '),number_format($stotal,2),'', number_format($igv,2),'', number_format($total,2)));
//===================PARA TOTALES================================================
