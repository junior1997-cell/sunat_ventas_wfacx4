...
$venta = new Venta();
$rspta = $venta->regventareportenpDia($_SESSION['idempresa']);
$rspta2 = $venta->regventareportetotalesnpDia( $_SESSION['idempresa']);
...
$pdf->Row(array('',utf8_decode('TOTAL NOTAS DE PEDIDO (S/): '),number_format($stotal,2),'', number_format($igv,2),'', number_format($total,2)));
//===================PARA TOTALES================================================
