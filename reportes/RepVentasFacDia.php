...
$venta = new Venta();
$rspta = $venta->regventareporteFacturaDia($_SESSION['idempresa']);
$rspta2 = $venta->regventareportetotalesFacturaDia( $_SESSION['idempresa']);
...
$pdf->SetWidths(array(8,20,25,25,45,10,15,18,15,18));
...
$pdf->SetFont('Arial','',7);
$pdf->Row(array($fechae, $tipod, $ncomprobante, $ndocliente, htmlspecialchars_decode($cliente), $tmoneda, $tcambio, $subtotal, $igv, $total));
}
//Imprime el detalle de todos los comprobantes
$pdf->Ln(1);
...
//Resumen
$pdf->SetWidths(array(145,15,1,15,1,15));
