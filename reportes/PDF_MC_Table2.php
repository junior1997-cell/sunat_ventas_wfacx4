...
if ($tipo=="RUC") {
    $rspta= $venta->ventasxCliente($ndoc,  $ano, $mes);
...
elseif($tipo=="RUCAG")
{
    $rspta= $venta->ventasxClienteAgrupado($ndoc, $ano, $mes);
    while($reg=$rspta->fetch_object())
    {
    $numero_documento=$reg->numero_documento;
    $razon_social=$reg->razon_social;
...
$this->Cell(120,6,utf8_decode('Nombre: ').utf8_decode(htmlspecialchars_decode($razon_social)),0,0,'C',0) ; 
$this->Ln(1);
//Titulos
$this->SetFont('courier','B',8);
