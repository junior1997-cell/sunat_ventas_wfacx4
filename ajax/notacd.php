...
// }
            ...
            $data[] = array(
                ...
                <li>
                     <a target="_blank" href="' . $url . $reg->idnota . $urlTipo . $reg->tipo_doc_mod . '">  <i class="fa  fa-print"  data-toggle="tooltip" title="Imprimir formato 2 copias" onclick=""> Imprimir Nota</i>
                    </a>
                </li>
