    ...
    case 'guardaryeditar':
      ...
      if (empty($idempresa)) {
        $rspta = $empresa->insertar( html_entity_decode($razonsocial, ENT_QUOTES | ENT_HTML401, 'UTF-8'), html_entity_decode($ncomercial, ENT_QUOTES | ENT_HTML401, 'UTF-8'),
          $domicilio, $ruc, $tel1, $tel2, $correo, $web, $webconsul, $imagen, $ubigueo, $igv, $porDesc, $codubigueo, $ciudad, $distrito, $interior, $codigopais, $banco1, 
      ...
      while ($reg = $rspta->fetch_object()) {
        ...
        $data[] = array(
          ...
          "1" => '<div class="d-flex align-items-center"> 
            <div class="me-2"> <span class="avatar avatar-rounded-3 cursor-pointer"> <img src="../files/logo/'.$imagen_pr.'" height="40px" width="auto" onerror="'.$imagen_error.'" onclick="ver_img_zoom(\'../files/logo/' .$imagen_pr . '\', \''.encodeCadenaHtml($reg->nombre_comercial).'\');" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Ver imagen"> </span> </div> 
            <div> 
