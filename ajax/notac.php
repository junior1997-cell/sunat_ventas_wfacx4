...
switch ($_GET["op"]) {
  case 'guardaryeditarnc':
    if (empty($idnota)) {
      $rspta = $notacd->insertarNC($idnota, $nombre, $serie, $numero_nc, $fecha, $codigo_nota, $desc_motivo, $tipo_doc_mod, $numero_comprobante, $tipo_doc_ide, 
      $numero_documento, $razon_social, $tipo_moneda, $sum_ot_car, $subtotal, $total_val_venta_oi, $total_val_venta_oe, $igv_, $sum_isc, $sum_ot, $total);
  ...
  case 'listar':
    ...
    //aqueir viene llave si surge otro error {
